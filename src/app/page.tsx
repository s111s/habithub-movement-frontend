...
export default function Home() {
  ...
  return (
    <main className="flex flex-col w-full max-w-[1300px] p-6 md:px-8 gap-6">
      ...
      {connected && (
        <>
          ...
          <button
            ...
            className="px-4 py-2 bg-orange-500 text-white rounded-md hover:bg-gray-600 transition"
          >
            {showWallet ? "Hide Wallet Info" : "Show Wallet Info"}
          </button>

          {/* 🔹 WalletConnection (Visible only if showWallet is true) */}
          {showWallet && (
            <WalletConnection
              account={account}
              network={network}
...
function WalletSelection() {
  ...
  return (
    ...
    //   </CardHeader>
    //   <CardContent>
    //     <div className="flex flex-wrap gap-6 justify-end items-right">
    //       {/* <div className="flex flex-wrap gap-6 pt-6 pb-12 justify-end items-right"> */}
